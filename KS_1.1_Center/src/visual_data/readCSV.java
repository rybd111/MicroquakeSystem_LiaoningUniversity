...
public class readCSV {
	...
	public readCSV(String filePath) {
		...
		SenChannel = new String[(Parameters.startTime+Parameters.endTime)*(Parameters.FREQUENCY+200)][this.senNum];
	 ...
	 */
	private TimeSeries readContents() throws NumberFormatException, IOException {
		int count=0;
        //(文件完整路径),编码格式
...
//            System.out.println(reader.readLine());
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		readCSV r = new readCSV("D:/data/ConstructionData/5moti/1652347 2019-12-21 16-40-18`56.csv");
		r.readContents();
